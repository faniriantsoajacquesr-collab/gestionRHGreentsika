...
<h2 class="text-2xl font-bold font-display text-text-light dark:text-text-dark">Mon Profil</h2>
...
<button class="bg-primary text-secondary font-bold font-display py-3 px-6 rounded-lg hover:bg-primary/90 transition-colors shadow-soft" type="submit">
