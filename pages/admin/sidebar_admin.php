...
<aside class="w-64 bg-secondary dark:bg-background-dark border-r border-accent dark:border-secondary/20 flex-shrink-0">
    ...
    <nav class="p-4 space-y-2">
        ...
        <a href="#" class="flex items-center gap-3 px-4 py-2 rounded-lg <?php echo ($activePage === 'parametres') ? 'text-white dark:text-text-dark bg-primary/20 font-semibold' : 'text-gray-300 dark:text-text-muted-dark hover:bg-primary/20 hover:text-white'; ?> transition-colors">
